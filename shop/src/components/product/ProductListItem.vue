    ...
    <div 
            ...
            >
              ...
              <ul class="actions">
                ...
                <li><button class="btn bg-vue" data-tip="Zum Warenkorb"><i class="fa fa-shopping-cart" @click="addProductToCart(productItem)"></i></button></li>
              </ul>
              ...
              <div class="card-body">
                ...
                <div class="text-center mt-3">
                  <div class="lead">
                    ...
                    <span v-if="productItem.price !== productItem.origPrice" class="ml-4 color-vue2"><del>€ {{ productItem.origPrice }} </del></span>
                  </div>
                </div>
              </div>
    </div>
...
export default {
    ...
    computed: {
        getDiscount() {
            return parseFloat(100 - (this.productItem.price / this.productItem.origPrice * 100)).toFixed(0);
        }
    },
    methods: {
...
.actions {
  ...
  .card .product-sale-label {
    color: #fff;
    background-color: rgb(253, 65, 80);
    font-size: 14px;
